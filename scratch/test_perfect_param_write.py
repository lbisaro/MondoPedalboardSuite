...
def main():
    ...
    try:
        ...
        pre_packet_x80 = [
            ...
            0x00, "XX", 0x00, 0x10, conn.session_no, conn.preset_last_ack_double[0], conn.preset_last_ack_double[1], 0x00
        ]
        ...
        focus_pkt_cd04 = [
            ...
            0x80, 0x10, 0xed, 0x03,
            0x00, "XX",  0x00, 0x04,
            conn.session_no, conn.preset_last_ack_double[0], conn.preset_last_ack_double[1], 0x00,
            0x01, 0x00, 0x06, 0x00,
            0x0d, 0x00, 0x00, 0x00,
