...
class PresetCompareWidget(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        smooth_layout.addSpacing(20)
        
        # Target Profile selection
        smooth_layout.addWidget(QtWidgets.QLabel("Target Profile:"))
        ...
        smooth_layout.addWidget(self.target_sel)
    ...
    def on_target_changed(self, target_name):
        ...
        parent_win = self.window()
        if hasattr(parent_win, 'load_settings'):
            settings = parent_win.load_settings()
